...
import codapackupdater.json.JSONArray;
...
public class Main {
    ...
    public static class UpdatingProcess{
        ...
        public void getUpdatesInfo(){
            try {
                ...
                for(int i=0, count = 0; i<updates.length(); i++){
                    ...
                    if( LocalConfiguration.updateNeeded(object.getString("version")) ){
    ...
    public static void main(String[] args) throws MalformedURLException, IOException, JSONException {        
        ...
        if(f.exists()){
            ...
            try {
                ...
                if(LocalConfiguration.updateNeeded(serverData.getString("codapack-version")))
                    new UpdatingProcess();
